...
import 'package:flutter_screenutil/flutter_screenutil.dart'; // Import for consistency with avatar component
...
class AppHeader extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              // Enlarged Profile Image using the saved avatar
              Container(
                width: 60,
                height: 60,
                decoration: BoxDecoration(
                ...
                // Use the AvatarData utility to display the saved avatar
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(16),
                  child: FutureBuilder(
                    // Load avatar data when building this widget
                    future: _loadAvatarData(),
                    builder: (context, snapshot) {
                      ...
                      // Return the avatar widget from our AvatarData class
                      return AvatarData.getCurrentAvatarWidget(
                        width: 60,
                        height: 60,
                        borderRadius: 16,
                      );
  ...
  // Helper method to load avatar data
  Future<void> _loadAvatarData() async {
    // Load the avatar data if it hasn't been loaded yet
