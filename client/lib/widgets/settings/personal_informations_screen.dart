...
class _PersonalInformationScreenState extends State<PersonalInformationScreen> {
    ...
    try {
      ...
      if (!serviceEnabled) {
        _showLocationPermissionDialog(
          ...
          'Location services are disabled on your device. Please enable location services in your device settings to automatically detect your location.',
          showSettings: true,
        );
        return false;
      }
      ...
      if (permission == LocationPermission.denied) {
        ...
        bool shouldRequest = await _showLocationPermissionDialog(
          'Location Permission Required',
          'We need access to your location to automatically fill in your address. This helps us provide better personalized services.',
          showSettings: false,
        );
        ...
        if (permission == LocationPermission.denied) {
          _showLocationPermissionDialog(
            'Permission Denied',
            'Location permission was denied. You can still manually enter your location or grant permission later in app settings.',
            showSettings: false,
          );
          return false;
        }
      ...
      if (permission == LocationPermission.deniedForever) {
        _showLocationPermissionDialog(
          ...
          'Location permissions are permanently denied. Please enable them in your device settings to use automatic location detection.',
          showSettings: true,
        );
        return false;
      }
  ...
  Future<bool> _showLocationPermissionDialog(String title, String message, {required bool showSettings}) async {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: Text(
                showSettings ? 'Open Settings' : 'Allow',
                style: GoogleFonts.plusJakartaSans(
                  fontWeight: FontWeight.w600,
                ),
              ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Location auto-detected: $address',
                    style: GoogleFonts.plusJakartaSans(
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Expanded(
                child: Text('Unable to detect location automatically. You can enter it manually.'),
              ),
            ],
          ),
  ...
  Future<void> _fetchUserData() async {
    ...
    try {
      ...
      // Auto-detect location after loading user data
      _autoDetectLocation();
    } catch (e) {
      setState(() {
        isLoading = false;
            ...
            children: [
              ...
              ListTile(
                leading: Container(
                  ...
                  child: const Icon(Icons.photo_library, color: Color(0xFF1E293B)),
                ),
                title: Text(
                  'Choose from Gallery',
                  style: GoogleFonts.plusJakartaSans(
  ...
  // Updated date picker with Material Design theme
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Text(
                      'Selected: ${selectedDate.day.toString().padLeft(2, '0')}/'
                          '${selectedDate.month.toString().padLeft(2, '0')}/'
                          '${selectedDate.year}',
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 16,
  ...
  Widget _buildEditableField({
    ...
    return GestureDetector(
      onTap: () {
        // Enable edit mode when tapping anywhere on the field
        if (!isEditing) {
          setState(() {
            editModeMap[fieldKey] = true;
          });
        }
      },
      child: Container(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(
                  ...
                  color: isEditing ? Colors.green : Colors.grey.shade400,
                  size: 20,
                ),
              ),
            ),
                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 16,
                        color: isLoadingLocation || locationController.text.isEmpty
                            ? Colors.black45
                            : Colors.black87,
                        fontWeight: FontWeight.w500,
                      ),
            ...
            if (!isLoadingLocation) ...[
              ...
              GestureDetector(
                ...
                child: Container(
                  padding: const EdgeInsets.all(4),
                  child: Icon(
                    editModeMap['location']! ? Icons.check : Icons.edit,
                    color: editModeMap['location']! ? Colors.green : Colors.grey.shade400,
                    size: 20,
                  ),
                ),
              ),
